...
/*!****************************************************************************!*\
  !*** ./app/content/price-check-notification/notification-iframe/js/app.ts ***!
  \****************************************************************************/
...
function onBtnContinueClick() {
    if (muteCheckboxEl.checked) {
        dispatcher.emit(new src_1.MarioEvent(ECommerceModule_events_1.ECommerceModuleEvents.MUTE_NOTIFICATION));
    }
    sendIframeEvent(PriceCheckIframeEvents_1.PriceCheckIframeEvents.OK, { mute: muteCheckboxEl.checked });
}
